...
> **Windows users:** Archon runs natively on Windows — no WSL2 required. Install [Git for Windows](https://git-scm.com/) (which includes Git Bash) and [Bun for Windows](https://bun.sh/docs/installation#windows). One caveat: DAG workflow `bash:` nodes need a bash executable — Git Bash provides this automatically. If you run into issues, see the [Windows notes](windows.md) in the main README.
...
The CLI is standalone, but if you also want to interact via Telegram, Slack, Discord, or GitHub webhooks, see the [README Server Setup](../README.md#quickstart) or run the setup wizard by opening Claude Code in the Archon repo and saying "set up archon".
...
| ------------------- | --------------- | --------------------------------------------------------------------- |
| **Telegram**        | Easy (5 min)    | [README: Telegram Setup](../README.md#add-a-platform) |
| **Discord**         | Easy (5 min)    | [README: Discord Setup](../README.md#add-a-platform)  |
| **Slack**           | Medium (15 min) | [docs/slack-setup.md](slack-setup.md)                                 |
| **GitHub Webhooks** | Medium (15 min) | [README: GitHub Setup](../README.md#add-a-platform)   |
...
See [Authoring Workflows](authoring-workflows.md) and [Authoring Commands](authoring-commands.md).

### Deploy to a server

For always-on access from any device, see the [Cloud Deployment Guide](cloud-deployment.md).
...
- [New Developer Guide](new-developer-guide.md) — How Archon works (concepts and architecture)
- [Configuration](configuration.md) — All configuration options
- [Authoring Workflows](authoring-workflows.md) — Creating custom workflows
