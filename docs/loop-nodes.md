...
- [Authoring Workflows](authoring-workflows.md) — full workflow reference
- [Per-Node Hooks](hooks.md) — SDK hooks for command/prompt nodes
- [Per-Node MCP Servers](mcp-servers.md) — external tool integration
- [Per-Node Skills](skills.md) — skill preloading
