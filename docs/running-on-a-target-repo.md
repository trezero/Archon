# Running Archon on a Target Repo
...
The CLI is standalone, but if you also want to interact via Telegram, Slack, Discord, or GitHub, see the [Getting Started guide](getting-started.md) for server setup.
